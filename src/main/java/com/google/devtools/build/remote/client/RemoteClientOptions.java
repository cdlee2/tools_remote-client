...
public final class RemoteClientOptions {
  ...
  @Parameters(
      commandDescription = "Sets up a directory and docker command to locally run a single"
      + "action given its Action proto. This requires the Action's inputs to be stored in CAS so"
  ...
  public static class RunCommand {
    @Parameter(
        ...
        required = true,
        converter = FileConverter.class,
        description = "Path to the Action proto stored in protobuf text format to be run in the "
            + "container."
    )
    public File file = null;
  }
